...
SRC_URI="x86? ( mirror://vmware/software/wkst/VMware-workstation-e.x.p-99530.i386.tar.gz )
		 amd64? ( mirror://vmware/software/wkst/VMware-workstation-e.x.p-99530.x86_64.tar.gz )"
